"""
Phase 17: identical copy of phase 12's shared CIR benchmark loading +
...
pattern phases 12b/12c/12d used, so phase 17 is scored against the exact
same queries and candidate pools as phases 12/12b/12c/12d, with no risk of
drift.
"""
import json
