"""Phase 23: shared CIR benchmark loading + Recall@K evaluator, copied from
phase 12's cir_eval.py, parametrized to accept either the val or the test
benchmark path (this phase's whole point is keeping those two strictly
separate, so a single hardcoded path here would be a bug)."""
import json
