"""
Phase 12d: identical copy of phase 12's shared CIR benchmark loading +
Recall@K evaluator, BENCHMARK_JSON pointed directly at phase 12's original
`cir_benchmark.json` -- same reuse pattern phases 12b/12c used, so phase 12d
is scored against the exact same queries and candidate pools throughout.
"""
import json
