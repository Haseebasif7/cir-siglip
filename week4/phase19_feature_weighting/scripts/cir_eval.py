"""
Phase 19: identical copy of phase 12's shared CIR benchmark loading +
Recall@K evaluator (`week4/phase12_controllable_modes/scripts/cir_eval.py`),
same reuse pattern phases 12b/12c/12d/17 used -- BENCHMARK_JSON points
directly at phase 12's original `cir_benchmark.json`, so phase 19 is scored
against the exact same queries and candidate pools as every other
configuration in this project's comparison table.
"""
import json
