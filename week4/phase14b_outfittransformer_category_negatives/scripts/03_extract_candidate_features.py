"""
Phase 14b, step 3 prep: same as phase 14's own
`02_extract_candidate_features.py`, unchanged logic -- compute the trained
model's context-independent candidate embedding (`embed_item_alone`) for
all 251,008 catalog items, using THIS phase's checkpoint (category-negative
fix applied during training) instead of phase 14's.
"""
import sys
