"""
Phase 14b, ablation run: same as 04_cir_eval.py, pointed at the
random-same-category-negatives checkpoint and candidate features.
"""
import json
import sys
...
CANDIDATE_NPZ = BASE_DIR / "embeddings" / "outfit_transformer_candidate_features_random_negatives.npz"
CHECKPOINT_PT = BASE_DIR / "models_random_negatives" / "outfit_transformer_siglip_random_neg_best.pt"
OUT_JSON = BASE_DIR / "data" / "cir_results_random_negatives.json"
