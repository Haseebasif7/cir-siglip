"""
Phase 12: shared CIR benchmark loading + Recall@K evaluator, reused by every
evaluation script in this phase so every configuration (raw SigLIP, phase 9's
model, this phase's substitute/complement/blend modes) is scored against the
exact same queries and candidate pools built by 01_build_cir_benchmark.py.
"""
import json
...
BENCHMARK_JSON = BASE_DIR / "data" / "cir_benchmark.json"
