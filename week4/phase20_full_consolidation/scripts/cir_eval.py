"""
Phase 20: identical copy of phase 12's shared CIR benchmark loading +
Recall@K evaluator, same reuse pattern phases 12b/12c/12d/17/19 used --
BENCHMARK_JSON points directly at phase 12's original `cir_benchmark.json`,
so phase 20's verification is scored against the exact same queries and
candidate pools as every other configuration in this project's comparison
tables.
"""
import json
