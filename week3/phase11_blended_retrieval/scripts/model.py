"""
Shared model code (identical to phases 7/8/9's -- same architecture), needed
here only to load phase 8's and phase 9's existing trained checkpoints and
project embeddings through them. No training happens in phase 11. Copied
rather than imported cross-phase, consistent with this project's convention
of keeping each phase's folder self-contained.
"""
import torch
