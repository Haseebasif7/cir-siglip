"""
Phase 7 shared model + loss code, used by both 05_train_projection.py and
06_evaluate_projection.py. Factored out (rather than duplicated per script,
as most other phases' small helpers have been) because this piece is
correctness-critical and shared identically by training and evaluation --
the same risk the ThreadPoolExecutor download deviation was accepted for in
step 1, applied here to model code instead of I/O code.
"""
import torch
